...
object DwsQzDao {
  ...
  def getDwsQzChapter(sparkSession: SparkSession,dt : String): sql.DataFrame = {
  ...
  def getDwsQzCourse(sparkSession: SparkSession,dt : String): sql.DataFrame = {
  ...
  def getDwsQzMajor(sparkSession: SparkSession,dt : String): sql.DataFrame = {
  ...
  def getDwsQzPaper(sparkSession: SparkSession,dt : String): sql.DataFrame = {
  ...
  def getDwsQzQuestion(sparkSession: SparkSession,dt : String): sql.DataFrame = {
